...
echo "Generating tools README for src/universal_mcp_calendly/app.py..."
universal_mcp readme src/universal_mcp_calendly/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_calendly/README.md
